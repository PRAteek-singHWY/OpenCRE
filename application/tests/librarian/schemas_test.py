...
_GOLDEN_SCHEMA = os.path.join(
    _REPO_ROOT, "gsoc-notes", "bonding", "golden_dataset.schema.json"
)
...
class TestGoldenDataset(unittest.TestCase):
    """The internal harness row mirrors gsoc-notes/bonding/golden_dataset.schema.json."""
